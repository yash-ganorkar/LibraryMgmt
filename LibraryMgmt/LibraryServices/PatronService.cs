...
namespace LibraryServices
{
    public class PatronService : IPatron
    {
        ...
        {
            var cardId = GetCard(patronId).Id;
        ...
        public IEnumerable<Checkout> GetCheckouts(int patronId)
        {
            ...
            return _context.Checkouts.Include(ch => ch.LibraryCard)
                .Include(ch => ch.LibraryAsset)
                .Where(ch => ch.LibraryCard.Id == cardId);
        }

        private LibraryCard GetCard(int patronId)
        {
            return _context.Patrons.Include(patron => patron.LibraryCard)
                        .FirstOrDefault(patron => patron.Id == patronId).LibraryCard;
        }
